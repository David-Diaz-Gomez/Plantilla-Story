...
require([
  ...
  view.when(function() {
    ...
    var swipe = new Swipe({
      view: view,
      leadingLayers: [webmapAfter.layers.items[1]], // Capa principal del segundo WebMap
      trailingLayers: [webmapAfter.layers.items[0]], // Capa secundaria del segundo WebMap
      position: 50,
